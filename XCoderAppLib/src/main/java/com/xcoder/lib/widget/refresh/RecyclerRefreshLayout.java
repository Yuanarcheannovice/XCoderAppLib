...
public class RecyclerRefreshLayout extends ViewGroup
    ...
    private RefreshIDragDistanceConverter mDragDistanceConverter;

    private RefreshIRefreshStatus mIRefreshStatus;
    ...
    private void initRefreshView() {
        ...
        mRefreshView.setVisibility(View.GONE);
        if (mRefreshView instanceof RefreshIRefreshStatus) {
            mIRefreshStatus = (RefreshIRefreshStatus) mRefreshView;
        } else {
...
//        mDragDistanceConverter = new RefreshMaterialDragDistanceConverter();
        mDragDistanceConverter = new RefreshDragDistanceConverterEg();
    }
    ...
    public void setRefreshView(View refreshView, ViewGroup.LayoutParams layoutParams) {
        ...
        if (refreshView instanceof RefreshIRefreshStatus) {
            mIRefreshStatus = (RefreshIRefreshStatus) refreshView;
        } else {
            throw new ClassCastException("the refreshView must implement the interface IRefreshStatus");
        }
    ...
    public void setDragDistanceConverter(@NonNull RefreshIDragDistanceConverter dragDistanceConverter) {
